...
const cards = [
  {
    to: '/app/secretary/aid-requests',
    title: 'طلبات المساعدة',
    desc: 'مراجعة طلبات المستفيدين واعتمادها أو رفضها، ونشر الحالات الطارئة للمتبرعين.',
  },
  {
    ...
    <div className="space-y-10">
      <section className="rounded-3xl border border-violet-300/25 bg-gradient-to-br from-violet-500/18 via-indigo-500/12 to-slate-900/30 p-6 shadow-[0_25px_60px_-30px_rgba(124,58,237,0.7)] backdrop-blur">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-white/72">
          هذه المساحة مخصّصة لمهام السكرتيرة: طلبات المساعدة، تنظيم المواعيد الطبية، والسجل الطبي والمختبر.
          إدارة المستفيدين والحملات وفرص التطوع تتم من مساحة أمين السر.
        </p>
      </section>
