...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($defaultUsers as $data) {
            ...
            $usersByRole[$data['role']->value] = $user;
        }
        ...
        $accountant = $usersByRole[UserRole::Accountant->value];
        $storekeeper = $usersByRole[UserRole::Storekeeper->value];
        $secretary = $usersByRole[UserRole::Secretary->value];
        $volunteer = $usersByRole[UserRole::Volunteer->value];
