    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="mr-1.5 space-x-0.5 py-0!">
                ...
                <flux:navbar.item class="h-10 max-lg:hidden text-sm text-emerald-600 dark:text-emerald-400" href="#" label="Hanin Charity" />
            </flux:navbar>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="px-2 py-3 text-sm text-emerald-600 dark:text-emerald-400">Hanin Charity Platform</div>
        </flux:sidebar>
